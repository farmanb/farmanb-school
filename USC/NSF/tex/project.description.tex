...
\item
  ...
  For dimension two, this also holds true for surfaces that are not elliptic, abelian, or K3 \cite[Prop. 12.1]{HuyFMT}.
...
Beyond these, work at the Fields Institute will help foster international connections, not only between the Canadian researchers based in Toronto, but with the many other international researchers who visit.
