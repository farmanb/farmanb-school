...
\begin{ex2}
  ...
  \begin{proof}
    ...
    \item
      ...
      Since every non-zero element of $\mathbb{Z}/p\mathbb{Z}$ generates the group, it is clear that one may then produce a collection of transpositions for which their product applied to $\alpha_k$ is $\alpha_2$.
