  ...
  \begin{proof}
    \begin{enumerate}[(a)]
      ...
      \item
        ...
        Consider $\Z/p\Z \times \Z/p\Z$. 
        Using the usual equivalence relation for constructing the field of fractions for an integral domain modulo $p$, $(a,b) \sim_p (c,d)$ if and only if $ad \equiv bc \pmod{p}$, we may identify $R$ with $(\Z/p\Z \times \Z/p\Z)/\sim_p$.
    \end{enumerate}
  \end{proof}
\end{thm}
