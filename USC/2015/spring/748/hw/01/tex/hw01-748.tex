...
\begin{ex}
  Show that a sequence of $R$-modules $A \rightarrow B \rightarrow C$ is exact if and only if its dual $C^* \rightarrow B^* \rightarrow A^*$ is exact, where $\ ^*$ denotes the Pontrjagin dual, $\Hom{\mathfrak{Ab}}{\ , \Q/\Z}$.

  \begin{proof}
    Since $\Q/\Z$ is injective, the contravariant functor $\Hom{\mathfrak{Ab}}{\ , \Q/\Z}$ is exact, so $A \rightarrow B \rightarrow C$ exact implies
    $$C^* \rightarrow B^* \rightarrow A^*$$
    is exact.

    Conversely, suppose $C^* \rightarrow B^* \rightarrow A^*$ is exact.
