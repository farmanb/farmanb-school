...
Let \(A\) and \(B\) be as in Chapter~\ref{chapter: background on NCP}. We want to extend the ideas from Section~\ref{subsection: graded Morita} to cover dg-enhancements of \(\mathrm{D}(\QGr{A})\). 
