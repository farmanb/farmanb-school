...
\begin{prop}
  ...
  \item
    ...
    \end{tikzcd}$$
  \item
    the presheaf of abelian groups $h_Q$ is exact, and
  \item
...
\begin{lem}\label{lem4}
  ...
  \begin{proof}
    ...
    \item
      Since $\omega$ being fully faithful is equivalent to $\eta$ being a natural isomorphism, this is a consequence of the definition of $\C/\A$.  
...
\begin{lem}\label{lem6}
  ...
  \begin{proof}
    ...
    \end{tikzcd}$$
    with $\pi(i)$ and $\pi(q)$ isomorphisms, the top left triangle commutative, and the outer square commutative.
    Therefore
