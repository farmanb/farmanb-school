...
As mentioned above, we have a natural enrichment of the category of chain complexes of graded modules over a graded ring.
...
\begin{lemma}\label{lem:GrModAsMod}
  ...
  \begin{proof}
    ...
    For each element \(g\) of \(G\), denote by \(A(g)[0]\) the complex with \(A(g)\) in degree zero and consider the full subcategory of \(\ldgGrMod{A}\) of all such complexes.
