...
\usepackage[url=false,style=uscauthoryear]{biblatex}
...
\advisor {Dr.}{Matthew R. Ballard}{Advisor}  %%% Be sure the 
\readera{Dr.}{Frank Thorne}{Reader}     %%% third field is 
\readerb{Dr.}{Jesse Kass}{Reader}          %%% the one used in 
\readerc{Dr.}{Andrew Kustin}{Reader} %%% your department.
\readerd{Dr.}{Michael Filaseta}{Reader}               %%% Only use as many as
...
\include{chapters/dgcats/intro}
\include{chapters/dgcats/modelStructure}
\include{chapters/dgcats/dgModules}
\include{chapters/dgcats/h-projectives}
\include{chapters/dgcats/derivedCategory}
\include{chapters/dgcats/tensorProducts}
\include{chapters/dgcats/bimodsAsMorphisms}

%Noncommutative Projective Schemes
\include{chapters/NCPS/intro}
\include{chapters/NCPS/gradedRingsAndModules}
\include{chapters/NCPS/quotientCats}
\include{chapters/NCPS/sheafCohomology}
\include{chapters/NCPS/noncomBiProjSchemes}
\include{chapters/NCPS/cohomologicalAssumptions}
\include{chapters/NCPS/segreProducts}

%Graded Morita Theory
\include{chapters/gradedMoritaintro}
\include{chapters/gradedMoritaringoidsAndModules}
\include{chapters/gradedMorita/derivedGradedMorita}

%Noncommutative Grade Morita Theory
\include{chapters/gradedNonComMorita/intro}
\include{chapters/gradedNonComMorita/vanishingOfATensorProduct}
\include{chapters/gradedNonComMorita/duality}
\include{chapters/gradedNonComMorita/products}
\include{chapters/gradedNonComMorita/theQuasiEquivalence}
