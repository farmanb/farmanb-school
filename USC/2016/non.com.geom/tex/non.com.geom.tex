...
\begin{prop}
  If $M$ is an object of $\qgr{A}$, then 
...
\begin{prop}
  Let $M$ be an object of $\Gr{A}$ and let $N$ be an object of $\QGr{A}$.
  Then
  \begin{enumerate}[(a)]
  \item
    For $i \geq 0$
  ...
  \end{tikzcd}$$
    ...
    \end{eqnarray*}
    and so by taking limits we get the exact sequence
    $$\begin{tikzcd}
      0 \arrow{r} & \lim_{n \rightarrow \infty}\HOM{\Gr{A}}{A/A_{\geq n}, M} \arrow{r} & M \arrow{r} & \underline{H}^0(\pi(M))\arrow{r} & \lim_{n \rightarrow \infty}\EXT{1}{\Gr{A}}{A/A_{\geq n}, M} \arrow{r} & 0
  \end{tikzcd}$$
