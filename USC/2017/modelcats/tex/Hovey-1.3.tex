...
%\begin{prop}
%  A Quillen adjunction $(F,U,\varphi) \colon \C \to \D$ induces a Quillen adjunction $(F_\ast, U_\ast, \varphi) \colon \C_\ast \to \D_\ast$ between the model categories of Proposition 1.1.8.
