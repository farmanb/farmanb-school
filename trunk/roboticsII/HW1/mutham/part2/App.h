...
class App : public DVC_AppGL {
 ...
 protected:
  ...
  GoalController *goalControllerBottom;
  GoalController *goalControllerFront;
  GoalController *goalControllerSide1;
  GoalController *goalControllerSide2;
  GoalController *goalControllerBack;
