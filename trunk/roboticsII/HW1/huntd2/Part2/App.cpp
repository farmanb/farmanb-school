...
KinematicalBody *App::GetGoalFront(){
  if (goalFrontBody)
...
KinematicalBody *App::GetGoalBack(){
  if (goalBackBody)
    return goalBackBody;
...
KinematicalBody *App::GetGoalSide1(){
  if (goalSide1Body)
...
KinematicalBody *App::GetGoalSide2(){
  if (goalSide2Body)
...
KinematicalBody *App::GetGoalBottom(){
  if (goalBottomBody)
...
bool App::AddGoalFrontController(){
  ...
  goalFrontController = new GoalFrontController(GetGoalFront());
...
bool App::AddGoalBackController(){
  ...
  goalBackController = new GoalBackController(GetGoalBack());
...
bool App::AddGoalSide1Controller(){
  ...
  goalSide1Controller = new GoalSide1Controller(GetGoalSide1());
...
bool App::AddGoalSide2Controller(){
  ...
  goalSide2Controller = new GoalSide2Controller(GetGoalSide2());
...
bool App::AddGoalBottomController(){
  ...
  goalBottomController = new GoalBottomController(GetGoalBottom());
