...
bool App::AddBatController(){
  ...
  batController = new BatController(GetBat(), GOAL_X_OFFSET);
...
bool App::AddGoalControllers()
{
  ...
  goalBaseCont = new GoalController(goalBottomBody, GOAL_X_OFFSET);
  goalFrontCont = new GoalController(goalFrontBody, GOAL_X_OFFSET);
  goalBackCont = new GoalController(goalBackBody, GOAL_X_OFFSET);
  goalSide1Cont = new GoalController(goalSide1Body, GOAL_X_OFFSET);
  goalSide2Cont = new GoalController(goalSide2Body, GOAL_X_OFFSET);
