...
bool App::AddGoalController(){
  ...
  goalController1 = new GoalController(goalBackBody);
...
if (goalController2){
  ...
  goalController2 = new GoalController(goalFrontBody);
  ...
  goalController3 = new GoalController(goalSide1Body);
  ...
  goalController4 = new GoalController(goalSide2Body);
  ...
  goalController5 = new GoalController(goalBottomBody);



  return sim->SetBodyControllerByName(*goalBack, *goalController1) && 
	     sim->SetBodyControllerByName(*goalFront, *goalController2) && 
		 sim->SetBodyControllerByName(*goalSide1, *goalController3)
		 && sim->SetBodyControllerByName(*goalSide2, *goalController4)
		 && sim->SetBodyControllerByName(*goalBottom, *goalController5);
}