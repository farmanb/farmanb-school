  ...
  */
  ...
  for (unsigned int i=0; i<4; i++){
    ...
    */
			...
			std::cout << "hello0 " << state << std::endl;

			//part 1


			if (palm->GetQ()[1] < 1.5 && state == 0)
			{
			...
			if (palm->GetQ()[1] > 1.5 && state ==0)
			{
				...
				SetPalmVelocity(0,0,0);
				std::cout << "hello2 " << state << std::endl;
			}
			...
			if(palm->GetQ()[0] < 1)
				{
					...
					std::cout << "hello3 " << state << std::endl;
				}
				else
				{
					state = 2;
			...
			//state 0
			if (palm->GetQ()[1] > 1 && state == 2)
			{
				SetPalmVelocity(0,-.001,0);
				std::cout << "hello4 " << state << std::endl;
			}
			//stop once it gets there
			if (palm->GetQ()[1] < 1 && state ==2)
			{
				...
				SetPalmVelocity(0,0,0);
				std::cout << "hello5 " << state << std::endl;
			}
			}
			...
			if (palm->GetQ()[1] < 1.5 && state == 3)
			{
				SetPalmVelocity(0,.01,0);
				std::cout << "hello6 " << state << std::endl;
			...
			if (state==5) 
			{
				...
				if (palm->GetQ()[1] > 1.1 && state == 5)
			{
				SetPalmVelocity(0,-.001,0);
				std::cout << "hello9 " << state << std::endl;
			...
			if (palm->GetQ()[1] < 1.1 && state ==5)
			{
				...
				std::cout << "hello10 " << state << std::endl;
			}
			}
			...
			//state 0
			if (palm->GetQ()[1] > 1 && state == 13)
			{
				SetPalmVelocity(0,-.002,0);
				std::cout << "hello4 " << state << std::endl;
